...
export const fractionVisualQuestions: FractionVisualQuestion[] = [
  ...
  // ── MORE EASY visual questions (very beginner-friendly) ──────────
  {
    id: 'fv-018',
    type: 'fraction_visual',
    topicId: 'thyesat',
    questionAl: 'Trego gjysmën (1/2) duke klikuar mbi një pjesë',
    shape: 'rectangle',
    numerator: 1,
    denominator: 2,
    hints: [
      'Drejtkëndëshi ka 2 pjesë',
      '1/2 = gjysma = 1 pjesë',
      'Kliko vetëm njërën anë',
    ],
    difficulty: 1,
  },
  {
    ...
    type: 'fraction_visual',
    topicId: 'thyesat',
    questionAl: 'Trego çerekun (1/4) duke klikuar 1 pjesë nga 4',
    shape: 'circle',
    numerator: 1,
    denominator: 4,
    hints: [
      'Rrethi ka 4 copa të barabarta',
      '1/4 = çereku = vetëm 1 copë',
      'Kliko njërën nga 4 copat',
    ],
    difficulty: 1,
  },
  {
    ...
    type: 'fraction_visual',
    topicId: 'thyesat',
    questionAl: 'Trego 2/2 (të tërën!) duke klikuar të dy pjesët',
    shape: 'rectangle',
    numerator: 2,
    denominator: 2,
    hints: [
      'Drejtkëndëshi ka 2 pjesë',
      '2/2 = e tëra = duhet t\'i ngjyrosësh TË DYJA!',
      'Kliko të dy kutitë',
    ],
    difficulty: 1,
  },
  {
    ...
    type: 'fraction_visual',
    topicId: 'thyesat',
    questionAl: 'Trego 2/3 duke klikuar 2 nga 3 pjesët',
    shape: 'rectangle',
    numerator: 2,
    denominator: 3,
    hints: [
      'Drejtkëndëshi ka 3 pjesë',
      'Numëruesi 2 = kliko 2 pjesë',
      'Lëre vetëm 1 bosh',
    ],
    difficulty: 1,
  },
  {
    ...
    type: 'fraction_visual',
    topicId: 'thyesat',
    questionAl: 'Trego 4/4 (katrorin e plotë) duke klikuar të gjitha pjesët',
    shape: 'square',
    numerator: 4,
    denominator: 4,
    hints: [
      'Katrori ka 4 pjesë gjithsej',
      '4/4 = 1 = e tëra! Kliko TË GJITHA!',
      'Ngjyrosi çdo pjesë',
    ],
    difficulty: 1,
  },
  // ── MORE MEDIUM visual questions ─────────────────────────────────
  {
    id: 'fv-023',
    type: 'fraction_visual',
    topicId: 'thyesat',
    questionAl: 'Trego 4/8 (gjysmën e picës) duke klikuar mbi fetat',
    shape: 'circle',
    numerator: 4,
    denominator: 8,
    hints: [
      'Pica ka 8 feta',
      '4/8 = gjysma = saktësisht 4 feta',
      'Kliko 4 nga 8 fetat',
    ],
    difficulty: 2,
  },
  {
    ...
    type: 'fraction_visual',
    topicId: 'thyesat',
    questionAl: 'Trego 6/9 të katrorit duke klikuar mbi pjesët',
    shape: 'square',
    numerator: 6,
    denominator: 9,
    hints: [
      'Katrori ka 9 pjesë (3×3)',
      '6/9 = 2/3 e katrorit',
      'Kliko 6 nga 9 katrorrët',
    ],
    difficulty: 2,
  },
  {
    ...
    type: 'fraction_visual',
    topicId: 'thyesat',
    questionAl: 'Trego 1/6 të rrethit duke klikuar vetëm 1 copë',
    shape: 'circle',
    numerator: 1,
    denominator: 6,
    hints: [
      'Rrethi ka 6 pjesë gjithsej',
      '1/6 = vetëm 1 copë e vogël',
      'Kliko saktësisht 1 copë',
    ],
    difficulty: 2,
  },
  {
    ...
    type: 'fraction_visual',
    topicId: 'thyesat',
    questionAl: 'Trego 4/5 duke klikuar 4 nga 5 pjesët',
    shape: 'rectangle',
    numerator: 4,
    denominator: 5,
    hints: [
      'Ka 5 pjesë gjithsej',
      '4/5 = pothuajse e tëra!',
      'Lëre vetëm 1 bosh, kliko 4',
    ],
    difficulty: 2,
  },
]
